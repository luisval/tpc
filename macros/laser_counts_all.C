...

{
  ...
  TH1F* hxy_entries1 = new TH1F("hxy_entries1","Bins multiplicity",60,0,600);
  hxy_entries1->SetFillColor(0); 
  hxy_entries1->SetLineColor(1);
  hxy_entries1->SetLineWidth(6);  

  TH1F* hxy_entries2 = new TH1F("hxy_entries2","Bins multiplicity",60,0,600);
  hxy_entries2->SetFillColor(0);
  hxy_entries2->SetLineColor(46);
  hxy_entries2->SetLineWidth(6);
 
 TH1F* hxy_entries3 = new TH1F("hxy_entries3","Bins multiplicity",60,0,600);
 hxy_entries3->SetFillColor(0);
 hxy_entries3->SetLineColor(41);
 hxy_entries3->SetLineWidth(6);

 TH1F* hxy_entries4 = new TH1F("hxy_entries4","Bins multiplicity",60,0,600);
 hxy_entries4->SetFillColor(0);
 hxy_entries4->SetLineColor(43);
 hxy_entries4->SetLineWidth(6);

 TH1F* hxy_entries5 = new TH1F("hxy_entries5","Bins multiplicity",60,0,600);
