...
class TpcDirectLaserReconstruction: public SubsysReco, public PHParameterInterface
{
  ...
  //  float mm = 1.0, cm = 10.0, m = 1000.0;  //um=1e-3,//changed to make 'cm' 1.0, for convenience. Used for the associated hits stuff
  ...
  //Associated hits to the laser
  TH3 *h_associated_laser = nullptr;
